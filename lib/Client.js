...
class Client extends EventEmitter {
  ...
  /**
   * Tell messenger to display or hide the typing animation on the conversation.
   * 🚧 This option is no longer available for european countries !
   *
   * @param {string} id User id
   * @param {boolean} toggle If the typing action should be set or removed
   */
  ...
  /**
   * Tell messenger to mark user's messages as read on the conversation.
   * 🚧 This option is no longer available for european countries !
   *
   * @param {string} id User id
   */
